                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('homedoctors.create') }}"
                            ...
                            <table class="table table-bordered">
                                ...
                                @forelse($doctors as $doctor)
                                    <tr>
                                        ...
                                        <td>{{ $doctor->name }}</td>
                                        <td><img src="{{ url($doctor->image) }}" style="width: 100px;" /></td>
                                      <td>
                                            <div class="operations-btns" style="">
                                                <a href="{{ route('homedoctors.edit', $doctor->id) }}"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content float-left">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('homedoctors.destroy', $doctor->id) }}"
                                                                        method="post">
                                                                        @csrf
                                                                        {{ method_field('delete') }}
                                                                        <button type="submit"
