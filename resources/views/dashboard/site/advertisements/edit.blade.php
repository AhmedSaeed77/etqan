    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('advertisements.update',$advertisement->id) }}" method="post" autocomplete="off"
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="name" type="text" class="form-control"
                                                   ...
                                                   value="{{$advertisement->name }}" placeholder="" >
                                        </div>
                                    </div>
                                    @error('name')
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="image" type="file" class="form-control"
                                                   id="exampleInputName1"
                                                   value="{{ $advertisement->image }}" placeholder="" >
                                        </div>
                                        @if ($advertisement->image !== null)
                                        <div class="col-2">
                                            <img src="{{ url($advertisement->image) }}" style="width: 100%;">
                                        </div>
                                    @endif
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea  name="description"   class="form-control summernote" id="exampleInputMainTitle2" placeholder="">{!! $advertisement->description !!}</textarea>
                                        </div>
                                    </div>
                                    @error('password')
                                    <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="date_time" type="datetime-local" class="form-control"
                                                   id="exampleInputName1"
                                                   value="{{ $advertisement->date_time }}" placeholder="" >
                                        </div>
                                    </div>
